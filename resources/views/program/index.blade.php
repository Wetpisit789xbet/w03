    ...
    <div >
        ...
        <div class="card-body">
            ...
            <button class="border rounded-lg p-4 mt-4">
                <a href="{{ route('programs.create') }}"><i class="fa fa-plus"></i> Create New item</a>
            </button>
                            ...
                            <tr>
                                ...
                                <td class="border-b">
                                    <form action="{{ route('programs.destroy', $item->id) }}" method="POST">
                                        <a class="border rounded-lg px-2" href="{{ route('programs.show', $item->id) }}"><i
                                                class="fa-solid fa-list"></i> Show</a>
                                        <a class="border rounded-lg px-2" href="{{ route('programs.edit', $item->id) }}"><i
