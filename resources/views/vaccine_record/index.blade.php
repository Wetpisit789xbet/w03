    ...
    <div class="card mt-5 w-[80%] mx-auto">
        ...
        <div class="card-body">
            ...
            <button class="border rounded-lg p-4 mt-4">
                <a href="{{ route('vaccine-records.create') }}"><i class="fa fa-plus"></i> Create New item</a>
            </button>
                    ...
                    <tbody>
                        @forelse ($vaccine_records as $item)
                            <tr>
                                ...
                                <td class="border-b">
                                    <form action="{{ route('vaccine-records.destroy', $item->id) }}" method="POST">
                                        <a class="border rounded-lg px-2" href="{{ route('vaccine-records.show', $item->id) }}"><i
                                                class="fa-solid fa-list"></i> Show</a>
                                        <a class="border rounded-lg px-2" href="{{ route('vaccine-records.edit', $item->id) }}"><i
